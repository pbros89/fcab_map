...
ContadorCarro _$ContadorCarroFromJson(Map<String, dynamic> json) {
  return _ContadorCarro.fromJson(json);
}

/// @nodoc
class _$ContadorCarroTearOff {
  const _$ContadorCarroTearOff();
  ...
  ContadorCarro fromJson(Map<String, Object?> json) {
    return ContadorCarro.fromJson(json);
  }
}

/// @nodoc
const $ContadorCarro = _$ContadorCarroTearOff();

/// @nodoc
mixin _$ContadorCarro {
  @JsonKey(name: 'estacion', defaultValue: '')
  ...
  @JsonKey(ignore: true)
  $ContadorCarroCopyWith<ContadorCarro> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ContadorCarroCopyWith<$Res> {
  factory $ContadorCarroCopyWith(
          ContadorCarro value, $Res Function(ContadorCarro) then) =
      _$ContadorCarroCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: 'estacion', defaultValue: '')
          String estacion,
      @JsonKey(name: 'linea', defaultValue: '')
...
/// @nodoc
class _$ContadorCarroCopyWithImpl<$Res>
    implements $ContadorCarroCopyWith<$Res> {
  _$ContadorCarroCopyWithImpl(this._value, this._then);

  final ContadorCarro _value;
  // ignore: unused_field
  final $Res Function(ContadorCarro) _then;
...
/// @nodoc
abstract class _$ContadorCarroCopyWith<$Res>
    implements $ContadorCarroCopyWith<$Res> {
  factory _$ContadorCarroCopyWith(
          _ContadorCarro value, $Res Function(_ContadorCarro) then) =
      __$ContadorCarroCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'estacion', defaultValue: '')
          String estacion,
...
/// @nodoc
class __$ContadorCarroCopyWithImpl<$Res>
    extends _$ContadorCarroCopyWithImpl<$Res>
    implements _$ContadorCarroCopyWith<$Res> {
  __$ContadorCarroCopyWithImpl(
      _ContadorCarro _value, $Res Function(_ContadorCarro) _then)
      : super(_value, (v) => _then(v as _ContadorCarro));

  @override
  _ContadorCarro get _value => super._value as _ContadorCarro;
...
/// @nodoc
@JsonSerializable()
class _$_ContadorCarro implements _ContadorCarro {
  _$_ContadorCarro(
      {@JsonKey(name: 'estacion', defaultValue: '')
  ...
  factory _$_ContadorCarro.fromJson(Map<String, dynamic> json) =>
      _$$_ContadorCarroFromJson(json);
  ...
  @override
  String toString() {
    return 'ContadorCarro(estacion: $estacion, linea: $linea, cant: $cant, codServicio: $codServicio, marcaMante: $marcaMante, color: $color, estadoCarga: $estadoCarga)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$ContadorCarroCopyWith<_ContadorCarro> get copyWith =>
      __$ContadorCarroCopyWithImpl<_ContadorCarro>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ContadorCarroToJson(this);
  }
}

abstract class _ContadorCarro implements ContadorCarro {
  factory _ContadorCarro(
      {@JsonKey(name: 'estacion', defaultValue: '')
          required String estacion,
      @JsonKey(name: 'linea', defaultValue: '')
          required String linea,
      ...
      @JsonKey(name: 'color', defaultValue: 'VERDER')
          required String color,
      @JsonKey(name: 'estado_carga', defaultValue: '')
          required String estadoCarga}) = _$_ContadorCarro;

  factory _ContadorCarro.fromJson(Map<String, dynamic> json) =
      _$_ContadorCarro.fromJson;
